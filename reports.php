    ...
    <div class="card-body">
        ...
        <div class="tab-content pl-3 p-1" id="myTabContent">
            <div class="tab-pane fade show active" id="today" role="tabpanel" aria-labelledby="today-tab">
                <?php
                $today_earning = 0;
                $today_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE (status = 'processed' OR status = 'completed' OR type = 'Walk-in') AND DATE(date_added) = CURDATE() ORDER BY date_added DESC" );
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_report.php?type=today' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
            ...
            <div class="tab-pane fade" id="yesterday" role="tabpanel" aria-labelledby="yesterday-tab">
                <?php
                $yesterday_earning = 0;
                $yesterday_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE (status = 'processed' OR status = 'completed' OR type = 'Walk-in') AND DATE(date_added) = CURDATE() - INTERVAL 1 DAY ORDER BY date_added DESC" );
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_report.php?type=yesterday' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php foreach( $yesterdays as $yesterday ) : ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <td>&#8369; <?php echo $yesterday['amount']; ?></td>
            ...
            <div class="tab-pane fade" id="week" role="tabpanel" aria-labelledby="week-tab">
                <?php
                $week_earning = 0;
                $week_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE (status = 'processed' OR status = 'completed' OR type = 'Walk-in') AND YEARWEEK(date_added) = YEARWEEK(CURDATE()) ORDER BY date_added DESC" );
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_report.php?type=week' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
                    <?php if( $week_count > 0 ) : ?>
            ...
            <div class="tab-pane fade" id="month" role="tabpanel" aria-labelledby="month-tab">
                <?php
                $month_earning = 0;
                $month_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE (status = 'processed' OR status = 'completed' OR type = 'Walk-in') AND MONTH(date_added) = MONTH(CURDATE()) ORDER BY date_added DESC" );
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_report.php?type=month' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
