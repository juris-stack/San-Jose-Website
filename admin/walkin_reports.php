...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            <h2 class="title-1">Walk-in Sales Reports</h2>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        ...
        <div class="tab-content pl-3 p-1" id="myTabContent">
            <div class="tab-pane fade show active" id="today" role="tabpanel" aria-labelledby="today-tab">
                ...
                if( $role == '3' ) {
                    $today_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND DATE(date_added) = CURDATE() ORDER BY date_added DESC" );
                }else if( $role == '2' ){
                    $today_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND DATE(date_added) = CURDATE() AND managed_by = '$managed_by' ORDER BY date_added DESC" );
                }                
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=today' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
            ...
            <div class="tab-pane fade" id="yesterday" role="tabpanel" aria-labelledby="yesterday-tab">
                ...
                $role = get_currentuser( 'role' );
                if( $role == '3' ) {
                    $yesterday_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND DATE(date_added) = CURDATE() - INTERVAL 1 DAY ORDER BY date_added DESC" );
                }else if( $role == '2' ){
                    $yesterday_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND DATE(date_added) = CURDATE() - INTERVAL 1 DAY AND managed_by = '$managed_by' ORDER BY date_added DESC" );
                }
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=yesterday' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="week" role="tabpanel" aria-labelledby="week-tab">
                ...
                $role = get_currentuser( 'role' );
                if( $role == '3' ) {
                    $week_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND YEARWEEK(date_added) = YEARWEEK(CURDATE()) ORDER BY date_added DESC" );
                }else if( $role == '2' ){
                    $week_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND YEARWEEK(date_added) = YEARWEEK(CURDATE()) AND managed_by = '$managed_by' ORDER BY date_added DESC" );
                }
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=week' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
                    <?php if( $week_count > 0 ) : ?>
            ...
            <div class="tab-pane fade" id="month" role="tabpanel" aria-labelledby="month-tab">
                ...
                $role = get_currentuser( 'role' );
                if( $role == '3' ) {
                    $month_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND MONTH(date_added) = MONTH(CURDATE()) ORDER BY date_added DESC" );
                }else if( $role == '2' ){
                    $month_earnings_stmt = $mysqli->prepare( "SELECT * FROM orders WHERE type = 'Walk-in' AND MONTH(date_added) = MONTH(CURDATE()) AND managed_by = '$managed_by' ORDER BY date_added DESC" );
                }
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=month' ); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
